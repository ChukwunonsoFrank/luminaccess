<x-app-layout>
    <h1>Cancelled withdrawals history</h1>
    <p><b>Total cancelled withdrawals</b>: ${{ $total_cancelled }}</p>
<br><br>
    <div class="card">
        <div class="card-header">
            <h4>View your cancelled withdrawal history below</h4>
        </div>
        <div class="card-body">
                        ...
                        <div class="col-sm-12">
                            <table class="table table-striped dataTable no-footer" id="table-2" role="grid"
                                ...
                                <tbody>
                                    ...
                                    @foreach($cancelled_withdrawals as $withdrawal)
