          ...
          <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            ...
            <div class="table-responsive">
              <table class="table table-hover table-bordered">
                ...
                <tbody>
                  @foreach($confirmed_withdrawals as $withdrawal)
                    <tr>
                      <td>#</td>
                      ...
                      <td style="width: 100px">
                        <a href="/admin/withdrawals/confirmed/details?id={{ $withdrawal->id }}" class="btn btn-sm btn-success" data-toggle="tooltip" data-placement="top" title="" data-original-title="Withdrawal Details">
