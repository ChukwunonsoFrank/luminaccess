                  ...
                  @foreach($matured_investments as $investment)
                    <tr>
                      ...
                      <td style="width: 100px">
                        <a href="/admin/investments/matured/details?id={{ $investment->id }}" class="btn btn-sm btn-success" data-toggle="tooltip" data-placement="top" title="" data-original-title="Investment Details">
